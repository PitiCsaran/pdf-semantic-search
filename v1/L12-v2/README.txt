=== PDF Semantic Search — multilingual-MiniLM-L12-v2 ===

Model:  paraphrase-multilingual-MiniLM-L12-v2
Size:   ~118 MB (downloaded once)
Port:   http://localhost:8080
Languages: 50+ including Thai and English
...
2. Download the model (ONE TIME — requires internet):
   ...
   Wait for all 4 files to finish (~1-2 minutes).
